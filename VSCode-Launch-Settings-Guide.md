        ...
        "configurations": [
            {
                ...
                // ↓↓↓ このenvブロックを追記する ↓↓↓
                "env": {
                    "SPRING_DATASOURCE_USERNAME": "R07PS_TEAM_D",
...
```properties
spring.datasource.url=jdbc:mysql://192.168.54.220/r07ps_team_d?serverTimezone=Asia/Tokyo&useSSL=false
spring.datasource.username=R07PS_TEAM_D
